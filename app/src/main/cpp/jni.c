...
Java_com_whispercpp_whisper_WhisperLib_00024Companion_fullTranscribe(
    ...
    // Language code from the JVM ("auto" => whisper auto-detects). Must stay alive
    // for the duration of whisper_full, so release only after the call returns.
    ...
    LOGI("About to run whisper_full (language=%s)", language_str);
